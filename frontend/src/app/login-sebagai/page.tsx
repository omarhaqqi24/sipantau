...
export default function LoginSelection() {
  ...
  return (
    ...
    >
      ...
      <h1 className={`text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold drop-shadow-lg ${marketName ? 'mt-0' : 'mt-20 sm:mt-24 md:mt-8 lg:mt-10'} mb-16 sm:mb-24 md:mb-32 lg:mb-40`}>
        LOGIN SEBAGAI
      </h1>
      ...
      <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-10 sm:gap-12 md:gap-16 lg:gap-20 max-w-6xl w-full px-4 sm:px-8">
        ...
        <button
          ...
          className="relative bg-red-700 rounded-3xl sm:rounded-4xl shadow-[8px_8px_20px_rgba(0,0,0,0.5)] pt-20 sm:pt-24 md:pt-28 lg:pt-29 pb-4 sm:pb-2 md:pb-1 px-4 sm:px-6 md:px-8 flex flex-col items-center space-y-4 sm:space-y-6 md:space-y-8 w-full sm:w-[20rem] md:w-[24rem] lg:w-[28rem] mx-auto sm:mx-0 hover:brightness-110 transition"
        >
          <img
            src="/assets/img/logofix.png"
            alt="Logo Dinas Pertanian"
            className="absolute -top-16 sm:-top-24 md:-top-32 lg:-top-45 h-36 w-36 sm:h-52 sm:w-52 md:h-64 md:w-64 lg:h-86 lg:w-86 object-contain filter drop-shadow-[0_20px_35px_rgba(0,0,0,0.1)]"
          />
          <span className="text-white font-bold text-base sm:text-lg md:text-xl lg:text-2xl text-center leading-snug">
        ...
        <button
          ...
          className="relative bg-yellow-500 rounded-3xl sm:rounded-4xl shadow-[8px_8px_20px_rgba(0,0,0,0.5)] pt-20 sm:pt-24 md:pt-28 lg:pt-30 pb-8 sm:pb-12 md:pb-14 lg:pb-16 px-8 sm:px-12 md:px-20 lg:px-29 flex flex-col items-center space-y-4 sm:space-y-6 md:space-y-8 w-full sm:w-[20rem] md:w-[24rem] lg:w-[28rem] mx-auto sm:mx-0 hover:brightness-110 transition"
        >
          <img
            src="/assets/img/tpid.png"
            alt="Logo Tim Pengendalian"
            className="absolute -top-16 sm:-top-24 md:-top-32 lg:-top-40 h-36 w-36 sm:h-52 sm:w-52 md:h-64 md:w-64 lg:h-86 lg:w-86 object-contain filter drop-shadow-[0_20px_35px_rgba(0,0,0,0.1)]"
          />
          <span className="text-white font-bold text-base sm:text-lg md:text-xl lg:text-2xl text-center leading-snug">
