...
export default function LoginTimPenanggulangan() {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        if (token) {
          ...
          console.log('[Login Tim Pengendalian] Session tersimpan dengan role:', role)
  ...
  return (
    ...
    >
      ...
      {/* Yellow background bawah */}
      <div className="bg-yellow-500 h-8 sm:h-10 md:h-12 w-[95%] sm:w-[85%] md:w-[70%] lg:w-[60%] xl:w-[55%] mx-auto rounded-b-2xl sm:rounded-b-3xl relative -mt-4 z-0 transition-all duration-300"></div>
